...
def main(df):
    ...
    p.add_argument("--train_years", default="2005-2010", help="Years for train split (forward mode).")
    p.add_argument("--test_years", default="2011-2025", help="Years for test split (forward mode).")
